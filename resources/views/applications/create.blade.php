...
@section('content')
<div class="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center py-12">
    <div class="w-full max-w-3xl mx-4">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-800 p-6 text-white">
            ...
            @if ($errors->any())
                <div class="mx-6 mt-6 p-4 bg-red-50 border border-red-200 text-red-700 rounded-md">
            ...
            <!-- Job Details Summary -->
            <div class="mx-6 mt-6 p-4 bg-blue-50 border border-blue-100 text-blue-700 rounded-md">
                <div class="flex items-start">
            ...
            <form action="{{ route('applications.store', $job->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="contact_email" id="contact_email"
                                class="w-full pl-10 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('contact_email') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="contact_phone" id="contact_phone"
                                class="w-full pl-10 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('contact_phone') border-red-500 @enderror"
                    ...
                    <div>
                        <label for="resume" class="block text-sm font-medium text-gray-700 mb-1">Resume (PDF or DOCX only) <span class="text-red-500">*</span></label>
                        ...
                        <input type="file" name="resume" id="resume"
                                ...
                                <div id="file-upload-ui" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50 hover:bg-gray-100 transition duration-200">
                            ...
                            <div id="upload-prompt" class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <div id="file-selected" class="hidden flex flex-col items-center justify-center pt-5 pb-6 w-full">
                                    ...
                                    <p class="text-sm font-medium text-gray-900 text-center" id="selected-filename">filename.pdf</p>
...
function updateFileNameDisplay(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        fileUploadUI.classList.remove('border-gray-300');
        ...
        fileUploadUI.classList.add('border-gray-300');
    }
}
</script>
@endsection
